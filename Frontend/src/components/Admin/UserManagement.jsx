...
const UserManagement = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
        <h2 className="text-2xl font-bold mb-4 text-black dark:text-white">User Management</h2>
        {/* {Add new user form} */}
        <div className="p-6 rounded-lg mb-6 bg-white dark:bg-gray-800 shadow-md">
            <h3 className="text-lg font-bold mb-4 text-black dark:text-white">Add New User</h3>
            <form onSubmit={handleSubmit}>
                <div className="mb-4">
                    ...
                    className='w-full p-2 border rounded border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white' />
                </div>
                <div className="mb-4">
                ...
                <div className="mb-4">
                    ...
                    <select name="role" value={formData.role} onChange={handleChange} className='w-full p-2 border rounded border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white'>
                ...
                <tbody>
                    {users.map((user) => (
                        <tr key={user._id} className='border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
                            <td className='p-4 font-medium text-gray-900 dark:text-white whitespace-nowrap'>{user.name}</td>
                            <td className='p-4'>{user.email}</td>
                            <td className='p-4'>
                                <select 
                                value={user.role}
                                onChange={(e) => handleRoleChange(user._id, e.target.value)}
                                className='p-2 border rounded border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white'>
                                    <option value="customer">Customer</option>
                                    <option value="admin">Admin</option>
                                </select>
                            </td>
