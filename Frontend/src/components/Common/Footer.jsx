      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-10">
        ...
        <div>
          ...
          <p className="text-gray-500 mb-4">
            Be the first to discover new products, attend exclusive events, and enjoy special online deals crafted just for you.
          </p>
          <p className="text-gray-600 font-medium text-sm mb-6">
            Sign up today and enjoy 10% off your first order.
          </p>
          <form className="flex">
            <input
              type="email"
              placeholder="Enter your email"
              className="w-full p-3 text-sm border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all"
              required
            />
            <button
              type="submit"
        ...
        <div>
          ...
          <div className="text-gray-500">
            ...
            <p className="flex items-center">
              <FiPhoneCall className="mr-2" /> +94 (77) 123 4567
            </p>
          </div>
        </div>
      </div>
