          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 md:p-8 flex flex-col justify-center">
                {product.brand && (
                  <span className="text-xs font-semibold text-accent-500 uppercase tracking-wider mb-2">
                    {product.brand}
                  </span>
                )}
                ...
                {product.colors?.length > 0 && (
                  <div className="mb-4">
                    <span className="text-xs font-semibold text-gray-900 dark:text-white uppercase tracking-wide block mb-2">
                      Color
                    </span>
